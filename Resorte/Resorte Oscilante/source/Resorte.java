...
public class Resorte extends PApplet {
...
float thetaEul = 1.0f;
float thetaVelEul = 0.0f;
float thetaAccEul = 0.0f;
...
PVector pos_euler = new PVector(0,0);
 ...
 public float Fuerzas(float pos, float vel) {   
...
if (key == 's'){ loop();}
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Resorte" };
    if (passedArgs != null) {
